...
function toggleTheme() {
  ...
  document.getElementById('themeBtn').textContent = next === 'dark' ? 'dark_mode' : 'light_mode';
  localStorage.setItem('theme', next);
}
(function initTheme() {
  const saved = localStorage.getItem('theme');
  if (saved) { document.body.dataset.theme = saved; document.getElementById('themeBtn').textContent = saved === 'dark' ? 'dark_mode' : 'light_mode'; }
})();
