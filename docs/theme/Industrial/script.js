...
function toggleTheme() {
  ...
  document.getElementById('themeBtn').innerHTML = next === 'dark' ? '<span class="material-symbols-outlined">dark_mode</span>' : '<span class="material-symbols-outlined">light_mode</span>';
  document.getElementById('themeBtn').setAttribute('aria-pressed', next === 'dark' ? 'true' : 'false');
...
(function initTheme() {
  ...
  if (saved) {
    ...
    document.getElementById('themeBtn').innerHTML = saved === 'dark' ? '<span class="material-symbols-outlined">dark_mode</span>' : '<span class="material-symbols-outlined">light_mode</span>';
    document.getElementById('themeBtn').setAttribute('aria-pressed', saved === 'dark' ? 'true' : 'false');
  }
})();
