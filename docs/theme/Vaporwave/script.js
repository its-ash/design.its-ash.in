...
(function initTheme() {
  ...
  const btn = document.querySelector('#themeBtn .material-symbols-outlined');
  if (btn) btn.textContent = saved === 'dark' ? 'dark_mode' : 'light_mode';
})();
...
console.log('Vaporwave landing page loaded ✅');